...
Object.keys( Colour.colours ).forEach( function( foreground ) {
  // Foregrounds
  Object.defineProperty( String.prototype, foreground, { value: function() {
    return Colour.colourise( this, { foreground: foreground } )
  }})
  // Backgrounds
  Object.keys( Colour.colours ).forEach( function( background ) {
    Object.defineProperty( String.prototype, foreground + '_on_' + background, { value: function() {
...
Object.keys( Colour.extras ).forEach( function( extra ) {
  // Extras
  Object.defineProperty( String.prototype, extra, { value: function() {
